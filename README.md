...
@kgossent/sfdx-md-merge-driver/0.1.24 win32-x64 node-v12.16.2
...
_See code: [src\commands\install.ts](https://github.com/KevinGossentCap/sfdc_merge/blob/v0.1.24/src\commands\install.ts)_
...
_See code: [src\commands\uninstall.ts](https://github.com/KevinGossentCap/sfdc_merge/blob/v0.1.24/src\commands\uninstall.ts)_
<!-- commandsstop -->
